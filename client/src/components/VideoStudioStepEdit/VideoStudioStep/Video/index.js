...
import { setVideo, removeVideoByFileId } from '../../../../actions/videoStepper';
...
class Video extends Component {
    ...
    fetchMyUploads = () => {
        const { page } = this.state;
        const myUploadsUrl = getUploadedUrl(uploadType.video, page);
    ...
    fetchAC = () => {
        const { page } = this.state;
        const animationClubUrl = getUploadedUrl(uploadType.video, page, uploadAccessType.public);
    ...
    render() {
        ...
        const { videoStepperVideo, editPreviewSwitched, setVideo, user } = this.props;
